<?php
    include_once("bd.php");
    function AddUser($LastName,$FirstName,$MiddleName,$DoB,$Gender,$Email,$MobilePhone,$Place,$Stud,$Social,$Size,$Growth,$Languages,$Password,$Password2,$DateTimeReg)
    {
    ...
    { 
        ...
        if (isset($_POST['submitvolunteer'])) {
            $error = AddUser($_POST['LastName'],$_POST['FirstName'],$_POST['MiddleName'],$_POST['DoB'],$_POST['Gender'],$_POST['Email'],$_POST['MobilePhone'],$_POST['Place'],$_POST['Stud'],$_POST['Social'],$_POST['Size'],$_POST['Growth'],$_POST['Languages'],$_POST['Password'],$_POST['Password2'],date("d-m-Y в H:i"));
            if (count($error) == 0) {

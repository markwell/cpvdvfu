...
<div class="tab-content">
	<div class="tab-pane active" id="events">Здесь будут выводиться ваши мероприятия.</div>
	<div class="tab-pane" id="profile">Форма просмотра и изменения анкеты.  <?php include ('users/organizers/cabinet/profile/profile.php'); ?></div>
